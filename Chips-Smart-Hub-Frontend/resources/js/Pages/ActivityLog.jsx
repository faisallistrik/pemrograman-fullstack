...
const actionBadgeClass = {
  created: 'bg-primary/10 text-primary dark:text-primary-dark',
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-heading font-extrabold text-ink dark:text-white">Log Aktivitas</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Riwayat perubahan data oleh seluruh pengguna.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white dark:bg-ink-soft rounded-lg">
            <p className="text-gray-600 dark:text-gray-400">Belum ada aktivitas tercatat</p>
          </div>
        ) : (
          <div className="bg-white dark:bg-ink-soft rounded-lg shadow divide-y divide-gray-100 dark:divide-white/10">
            {logs.map((log) => (
